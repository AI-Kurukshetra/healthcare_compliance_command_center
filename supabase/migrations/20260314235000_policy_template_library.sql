...
DROP POLICY IF EXISTS organization_policies_manage_same_org ON public.organization_policies;
DROP POLICY IF EXISTS organization_policies_select_same_org ON public.organization_policies;
DROP POLICY IF EXISTS policy_templates_manage_same_org ON public.policy_templates;
DROP POLICY IF EXISTS policy_templates_select_same_org_or_shared ON public.policy_templates;
